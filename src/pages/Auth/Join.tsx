  ...
  async function postInfo(e: any) {
    ...
    await axios
      .post(url, {
        ...
        birth:
          inputValue.year +
          inputValue.month.replace("월", "").padStart(2, "0") +
          inputValue.date.replace("일", "").padStart(2, "0"),
      })
      .then((response) => {
        ...
        <div className="join-body">
          ...
          <div className="join-body-main">
            ...
            <div className="join-body-input">
              <li
                className={
                  "join-li" + (inputValue.gender === "성별" ? "" : "confirm")
                }
              ...
              <ul className={"join-ul" + (open === "gender" ? "-gender" : "")}>
                <li className="join-ul-li" value={1} onClick={changeGender}>
                  남
                </li>
                <li className="join-ul-li" value={2} onClick={changeGender}>
                  여
                </li>
              </ul>
            </div>
            ...
            <div className="join-body-grid">
              ...
              <div className="join-body-input">
                <li
                  className={
                    "join-li" + (inputValue.month === "월" ? "" : "confirm")
                  }
              ...
              <div className="join-body-input">
                <li
                  className={
                    "join-li" + (inputValue.date === "일" ? "" : "confirm")
                  }
